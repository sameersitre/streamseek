...
import { getPersonInfo } from '../../../services/apiURL'
...
export default function PersonModal(props) {
  ...
  const { id, season_number, poster_path, overview, name, episode_count, air_date } = props.parentData
  ...
  useEffect(() => {
    ...
    async function getData() {
      ...
      let apiData = await apiCall(getPersonInfo, params)
      console.log({ apiData })
      ...
      <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={props.isOpen}>
        ...
        <Grid
          ...
          <div style={{ width: 200, margin: 5 }}>
            <Poster data={{ poster_path: poster_path }} />
